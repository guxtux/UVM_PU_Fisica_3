...
% Macro para agregar el logo de UVM en cada slid-e de la presentación
...
La unidad que mide la magnitud de fuerza en el Sistema Internacional, es el \textocolor{alizarin}{Newton}, que se abrevia \si{\newton}.
\end{frame}
\begin{frame}
...
% \pause
% \begin{align*}
% 1 \, \text{libra-fuerza} = \text{slug} \, \dfrac{\text{pie}}{\si{\square\second}}
% \end{align*}
% \end{frame}
\begin{frame}
...
% \bigskip
% \pause
% Su unidad son los Joules (J), equivale a un newton por metro (\si{\newton\meter}).
% \end{frame}
% \begin{frame}
