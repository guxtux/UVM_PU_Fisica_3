...
\includepdf[pages=-]{Caratula_Examen_Extraordinario_Fisica_3.pdf}
...
\begin{questions}
    ...
    \begin{tasks}(4)
        ...
        \task \SI{3.1536d16}{\nano\second}
    \end{tasks}
    % \question \textbf{Ejercicio de ejecución.} Si la velocidad del tren bala es de \SI{603}{\kilo\meter\per\hour}. ¿Qué distancia en metros ha recorrido en \SI{1}{\minute}?
    % \begin{tasks}(4)
    %     \task \SI{10015}{\meter}
    %     \task \SI{10050}{\meter}
    %     \task \SI{10055}{\meter}
    ...
    \begin{tasks}(4)
        ...
        \task Movimiento.
    \end{tasks}
    % \question Es la razón de cambio de la velocidad con respecto al tiempo: \rule{1.5cm}{0.1mm}
    % \begin{tasks}(4)
    %     \task Aceleración.
    %     \task Velocidad.
    %     \task Movimiento.
    ...
    \begin{tasks}(4)
        ...
        \task \SI{78}{\meter}
    \end{tasks}
    % Una persona viaja en motocicleta a una velocidad de \SI{3}{\meter\per\second} y acelera constantemente a razón de \SI{0.4}{\meter\per\square\second}. ¿Qué distancia recorrerá después de 1 minuto?
    % \begin{tasks}(4)
    %     \task \SI{900}{\meter}
    %     \task \SI{1000}{\meter}
    %     \task \SI{1500}{\meter}
    ...
    \begin{tasks}(4)
        ...
        \task \SI{12.97}{\second}
    \end{tasks}
    % Se lanza verticalmente hacia arriba una esfera metálica con una velocidad cuya magnitud es de \SI{20}{\meter\per\second}. ¿Qué distancia recorre a los \num{2} segundos?
    % \begin{tasks}(4)
    %     \task \SI{15.09}{\meter}
    %     \task \SI{20.38}{\meter}
    %     \task \SI{51.19}{\meter}
    ...
    % Una hélice gira inicialmente con una velocidad angular cuya magnitud es de \SI{10}{\radian\per\second} y recibe una aceleración constante cuya magnitud es de \SI{3}{\radian\per\square\second}. ¿Cuál será la magnitud de su velocidad angular después de \num{7} segundos?
    ...
    %     \task Nulificación
    % \end{tasks}
    % \question Es el tipo de corriente que se obtiene en un generador de electricidad como consecuencia de la Ley de Faraday: \rule{2cm}{0.1mm}
    % \begin{tasks}(4)
    %     \task Directa
    %     \task Alterna
    %     \task Cuadrada
    ...
    % \question Para considerar que se está realizando un trabajo mecánico, la fuerza que se aplica a un objeto debe de ser \rule{2cm}{0.1mm} 
    % % Es la capacidad de un sistema físico para realizar un trabajo:
    % \begin{tasks}(4)
    %     \task Constante.
    %     \task Variable.
    %     \task Pausada.
    ...
    % \end{tasks}
    % \question Son los procesos de transferencia de calor entre dos cuerpos:
    % \begin{multicols}{2}
    % \begin{tasks}
    %     \task Radiación, Convección, Conducción.
    %     \task Conducción, Evaporación, Radiación.
    %     \task Convección, Conducción, Condensación.
    %     \task Conducción, Radiación, Sublimación.
    % \end{tasks} 
    % \end{multicols}
    % El calor es una forma de energía que se transfiere entre dos sistemas (o entre partes de un sistema) debido a \rule{2cm}{0.1mm}.
    % \begin{tasks}
    %     \task una diferencia de temperatura.
    %     \task una suma de temperatura.
    %     \task a un descenso de temperatura.
    %     \task a un descenso de temperatura.
    % \end{tasks}
